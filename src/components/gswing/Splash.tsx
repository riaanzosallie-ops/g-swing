...
export const Splash = ({ onEnter }: { onEnter: () => void }) => (
  <div className="relative min-h-screen w-full overflow-hidden">
    ...
    <div className="relative z-10 flex min-h-screen flex-col items-center justify-between px-6 py-12">
      <div className="flex flex-1 flex-col items-center gap-2 pt-[68vh]">
        <p className="splash-shine text-[13px] uppercase tracking-[0.4em] text-gold/90 opacity-0 text-center [animation:splash-rise_1s_ease-out_0.3s_forwards]">
          Where Golf Meets Intelligence
        </p>
        <p className="splash-shine text-[9px] uppercase tracking-[0.32em] text-muted-foreground/70 opacity-0 text-center [animation:splash-rise_1s_ease-out_0.6s_forwards]">
