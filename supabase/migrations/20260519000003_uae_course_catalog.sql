-- UAE-wide GPS course metadata catalog.
-- Sharjah Golf and Shooting Club is intentionally first/main for G Swing GPS.

insert into golf_courses (id, name, city, country, lat, lng, holes_count, par, timezone) values
